...
2. **Type3 (11-bits)** - Type of the tag. This field is broken down further
   ...
   `0x000` is invalid and not assigned a type.
    ...
    1. **Type1 (3-bits)** - Abstract type of the tag. Groups the tags into
       ...
       :warning: list the (7) possible Type1 values (0b001 .. 0b111)
...
3. **Id (10-bits)** - File id associated with the tag. Each file in a metadata
   ...
   :question: - does this mean that (sub)directories do not have a block-unique id, but all contain 0x3ff?
...
:question: - does id identify the directory or 0x3ff as indicated [above, pt 3.](#Metadata-tags) 
